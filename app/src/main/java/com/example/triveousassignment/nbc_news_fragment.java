...
public class nbc_news_fragment extends Fragment implements Article_adapter.ArticleClickInterface, SwipeRefreshLayout.OnRefreshListener {
    ...
    public Uri builduri()
    {
        Uri builturi = Uri.parse(BASE_URL).buildUpon()
                .appendQueryParameter(SOURCES,"nbc-news")
    ...
    class HttpGetRequest extends AsyncTask<String, Void, List<Article>>
    {
        ...
        protected void onPostExecute(List<Article> result)
        {
            ...
            article_adapter = new Article_adapter(getContext(),mnews, nbc_news_fragment.this);
