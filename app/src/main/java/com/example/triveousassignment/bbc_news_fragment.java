...
public class bbc_news_fragment extends Fragment implements Article_adapter.ArticleClickInterface, SwipeRefreshLayout.OnRefreshListener {
    ...
    class HttpGetRequest extends AsyncTask<String, Void, List<Article>>
    {
        ...
        protected List<Article> doInBackground(String... strings)
        {
            ...
            try
            {
                ...
                connection.setRequestMethod("GET");Log.i("background:","Task1 Completed");
                connection.connect();
        ...
        protected void onPostExecute(List<Article> result)
        {
            ...
            article_adapter = new Article_adapter(getContext(),mnews, bbc_news_fragment.this);
